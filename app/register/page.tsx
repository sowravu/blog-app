                ...
                >
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <motion.div variants={itemVariants} className="space-y-2">
                            <label className="text-xs font-medium text-gray-300 block ml-1">Full Name</label>
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <UserIcon className="h-5 w-5 text-gray-400 group-focus-within:text-purple-400 transition-colors" />
                                </div>
                                <input
                                    type="text"
                    ...
                    <div className="mt-4 text-center">
                        <Link href="/login" className="text-gray-400 text-xs hover:text-white transition-colors">
